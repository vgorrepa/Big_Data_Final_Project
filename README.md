...
This is my final project for a Big Data Certificate course 
...
Sentiment Analysis will be conducted using the Python programming language.Various analytic tools will be utilized to conduct data analysis. Python programming language has powerful libraries such as NumPy, Pandas, Matplotlib which are utilized for high level mathematical functions, data manipulation and analysis. In addition, Python has Scikit-learn which is a Machine Learning library. Python will primarily be used for this project via Jupyter Notebook. Apart from this Microsoft Azure platform will also be used. A GitHub repository will be created, and reports created for this project will be uploaded there.                       
